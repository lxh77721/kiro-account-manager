...
> This project is based on the original Kiro Account Manager repository.
>
> Original repository: [chaogei/Kiro-account-manager](https://github.com/chaogei/Kiro-account-manager)
